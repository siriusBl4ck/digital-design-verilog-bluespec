...
module mkAlu(CLK,
  ...
  // register err
  assign err$D_IN = 1'd1 ;
  assign err$EN =
	     !rdy && opcode != 2'd0 && opcode != 2'd1 && opcode != 2'd2 &&
	     (opcode != 2'd3 || b == 32'd0) ;
  ...
  // register res
  always@(opcode or a_5_AND_b___d19 or a or b)
  begin
    case (opcode)
      2'd0: res$D_IN = a + b;
      2'd1: res$D_IN = a - b;
      2'd2: res$D_IN = b - a;
      2'd3: res$D_IN = a_5_AND_b___d19;
    endcase
  end
  assign res$EN =
	     !rdy &&
	     (opcode == 2'd0 || opcode == 2'd1 || opcode == 2'd2 ||
	      opcode == 2'd3 && b != 32'd0) ;

  // remaining internal signals
  assign a_5_AND_b___d19 = a & b ;
